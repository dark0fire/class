	...
	return function a(b, c, d)
	{
			...
			b.exports = function(a, b, c)
			{
				...
				return {
					...
					}, getCSS: function(a, b, c)
					{
						...
						if(c = c || {}, f && b.lastModified && new Date(b.lastModified).valueOf() === new Date(f).valueOf() && (!c && !g || JSON.stringify(c) === g))
						{
							return e
						}
					}
		...
		5: [function(a, b, c)
		{
			...
			b.exports = function(a, b, c)
			{
				function f(b, f)
				{
					var g, h, i = "less-error-message:" + d.extractId(f || ""), j = '<li><label>{line}</label><pre class="{class}">{content}</pre></li>', k = a.document.createElement("div"), l = [],
						m = b.filename || f, n = m.match(/([^\/]+(\?.*)?)$/)[1];
				...
				function j(a, d)
				{
					var e = "{line} {content}", f = a.filename || d, g = [], h = (a.type || "Syntax") + "Error: " + (a.message || "There is an error in your .less file") + " in " + f + " ",
						i = function(a, b, c)
						{
		...
		6: [function(a, b, c)
		{
			b.exports = function(b, c)
			{
				...
				}, g.prototype.doXHR = function(a, e, f, g)
				{
					...
					var i = d(), j = !b.isFileProtocol || b.fileAsync;
		...
		8: [function(a, b, c)
		{
			...
			b.exports = function(b, c)
			{
				...
				function j(a, b, e, h, i)
				{
					function j(c)
					{
						var d = c.contents, g = c.filename, i = c.webInfo, j = {currentDirectory: q.getPath(g), filename: g, rootFilename: g, relativeUrls: k.relativeUrls};
				...
				n.options = c;
				var o = n.environment, p = a("./file-manager")(c, n.logger), q = new p;
				o.addFileManager(q), n.FileManager = p, a("./log-listener")(n, c);
				var r = a("./error-reporting")(b, n, c), s = n.cache = c.cache || a("./cache")(b, c, n.logger);
		...
		15: [function(a, b, c)
		{
			...
			{
				var c, d, e = /^((?:[a-z-]+:)?\/{2}(?:[^\/\?#]*\/)|([\/\\]))?((?:[^\/\\\?#]*[\/\\])*)([^\/\\\?#]*)([#\?].*)?$/i, f = a.match(e), g = {}, h = [];
				if(!f)
				{
		...
		18: [function(a, b, c)
		{
			...
			h = {
				...
				}, hsva: function(a, b, c, d)
				{
					...
					var i = [c, c * (1 - b), c * (1 - g * b), c * (1 - (1 - g) * b)], j = [[0, 3, 1], [2, 0, 1], [1, 0, 3], [1, 2, 0], [3, 1, 0], [0, 1, 2]];
				...
				}, mix: function(a, b, c)
				{
					...
					var d = c.value / 100, e = 2 * d - 1, f = a.toHSL().a - b.toHSL().a, g = ((e * f == -1 ? e : (e + f) / (1 + e * f)) + 1) / 2, h = 1 - g,
						k = [a.rgb[0] * g + b.rgb[0] * h, a.rgb[1] * g + b.rgb[1] * h, a.rgb[2] * g + b.rgb[2] * h], l = a.alpha * d + b.alpha * (1 - d);
					return new j(k, l)
		...
		19: [function(a, b, c)
		{
			b.exports = function(b)
			{
				...
				e.add("data-uri", function(a, e)
				{
					...
					{
						if(h = b.mimeLookup(i), "image/svg+xml" === h)
						{
							o = !1;
						}
						else
		...
		25: [function(a, b, c)
		{
			var d = a("./function-registry"), e = a("./math-helper.js"), f = {ceil: null, floor: null, sqrt: null, abs: null, tan: "", sin: "", cos: "", atan: "rad", asin: "rad", acos: "rad"};
			for(var g in f)
			{
		...
		26: [function(a, b, c)
		{
			var d = a("../tree/dimension"), e = a("../tree/anonymous"), f = a("./function-registry"), g = a("./math-helper.js"), h = function(a, b)
			{
				...
				for(c = 0; c < b.length; c++)
				{
					...
					{
						if(h = "" === g.unit.toString() && void 0 !== l ? new d(g.value, l).unify() : g.unify(), j = "" === h.unit.toString() && void 0 !== k ? k : h.unit.toString(), k = "" !== j && void 0 === k || "" !== j && "" === m[0].unify().unit.toString() ? j : k, l = "" !== j && void 0 === l ? g.unit.toString() : l, f = void 0 !== n[""] && "" !== j && j === k ? n[""] : n[j], void 0 !== f)
						{
							i = "" === m[f].unit.toString() && void 0 !== l ? new d(m[f].value, l).unify() : m[f].unify(), (a && h.value < i.value || !a && h.value > i.value) && (m[f] = g);
						}
						else
						{
							if(void 0 !== k && j !== k)
					...
					{
						Array.isArray(b[c].value) && Array.prototype.push.apply(b, Array.prototype.slice.call(b[c].value));
					}
				}
		...
		28: [function(a, b, c)
		{
			b.exports = function(b)
			{
				...
				h.add("svg-gradient", function(a)
				{
					...
					for(j = '<?xml version="1.0" ?><svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="100%" height="100%" viewBox="0 0 1 1" preserveAspectRatio="none"><' + p + 'Gradient id="gradient" gradientUnits="userSpaceOnUse" ' + i + ">", k = 0; k < h.length; k += 1)
					{
		...
		29: [function(a, b, c)
		{
			var d = a("../tree/keyword"), e = a("../tree/detached-ruleset"), f = a("../tree/dimension"), g = a("../tree/color"), h = a("../tree/quoted"), i = a("../tree/anonymous"),
				j = a("../tree/url"), k = a("../tree/operation"), l = a("./function-registry"), m = function(a, b)
				{
			...
			l.addMultiple({
				...
				}, isunit: n, unit: function(a, b)
				{
					if(!(a instanceof f))
					{
						throw{type: "Argument", message: "the first argument to unit must be a number" + (a instanceof k ? ". Have you forgotten parenthesis?" : "")};
					}
		...
		30: [function(a, b, c)
		{
			var d = a("./contexts"), e = a("./parser/parser"), f = a("./plugins/function-importer");
			b.exports = function(a)
			{
				...
				return b.prototype.push = function(b, c, g, h, i)
				{
					...
					if(!m)
					{
						return void k({message: "Could not find a file-manager for " + b});
					}
					c && (b = m.tryAppendExtension(b, h.plugin ? ".js" : ".less"));
					var n = function(a)
					{
						var b = a.filename, c = a.contents.replace(/^\uFEFF/, "");
		...
		32: [function(a, b, c)
		{
			var d = a("./utils"), e = b.exports = function(a, b, c)
			{
				...
				if(b && e)
				{
					var f = b.contents[e], g = d.getLocation(a.index, f), h = g.line, i = g.column, j = a.call && d.getLocation(a.call, f).line, k = f.split("\n");
		...
		35: [function(a, b, c)
		{
			var d, e = a("./contexts"), f = a("./parser/parser"), g = a("./plugin-manager");
			b.exports = function(b, c, h)
			{
				var i = function(b, c, j)
				{
					...
					{
						var o = c.filename || "input", p = o.replace(/[^\/\\]*$/, "");
						m = {
							filename: o,
		...
		37: [function(a, b, c)
		{
			...
			b.exports = function()
			{
					...
					for(var e, f, j, p = k.i, q = c, s = k.i - i, t = k.i + h.length - s, u = k.i += d, v = b; k.i < t; k.i++)
					{
						if(e = v.charCodeAt(k.i), k.autoCommentAbsorb && e === r)
						{
							...
							if("*" === f)
							{
								...
								if(x >= 0)
								{
									j = {index: k.i, text: v.substr(k.i, x + 2 - k.i), isLineComment: !1}, k.i += j.text.length - 1, k.commentStore.push(j);
									continue
								}
							}
							break
				...
				}, k.end = function()
				{
					...
					return k.i < e && (a = f, k.i = e), {isFinished: c, furthest: k.i, furthestPossibleErrorMessage: a, furthestReachedEnd: k.i >= b.length - 1, furthestChar: b[k.i]}
				}, k
			}
		}, {"./chunker": 36}],
		38: [function(a, b, c)
		{
			var d = a("../less-error"), e = a("../tree"), f = a("../visitors"), g = a("./parser-input"), h = a("../utils"), i = function j(a, b, c)
			{
				function i(a, e)
				{
				...
				return {
					parse: function(g, h, i)
					{
						...
						{
							for(var r = a.pluginManager.getPreProcessors(),
									s = 0; s < r.length; s++)
							{
								g = r[s].process(g, {
									context: a,
						...
						primary: function()
						{
							for(var a, b = this.mixin, c = []; ;)
							{
								...
								else if(a = b.definition() || this.rule() || this.ruleset() || b.call() || this.rulesetCall() || this.entities.call() || this.directive())
								{
									c.push(a);
								}
								else
						...
						}, comment: function()
						{
							...
							}, call: function()
							{
								...
								if(!o.peek(/^url\(/i))
								{
									return o.save(), (a = o.$re(/^([\w-]+|%|progid:[\w\.]+)\(/)) ? (a = a[1], b = a.toLowerCase(), "alpha" === b && (f = n.alpha()) ? (o.forget(), f) : (d = this.arguments(), o.$char(")") ? (o.forget(), new e.Call(a, d, g, c)) : void o.restore("Could not parse call arguments or missing ')'"))) : void o.forget()
								}
							}, arguments: function()
							{
								var a, b, c, d = [], f = [], g = [];
						...
						}, extendRule: function()
						{
							...
							call: function()
							{
								var a, b, d, f, g, h, i = o.currentChar(), j = !1, k = o.i;
								if("." === i || "#" === i)
								{
									for(o.save(); ;)
									{
							...
							{
								var b, c, d, f, g, h, j, k = n.entities, l = {args: null, variadic: !1}, m = [], p = [], q = [];
								for(o.save(); ;)
								{
									if(a)
									{
									...
									if(a ? h.value && 1 == h.value.length && (r = h.value[0]) : r = h, r && r instanceof e.Variable)
									{
										...
										else if(o.$str("..."))
										{
											if(!a)
											{
												l.variadic = !0, o.$char(";") && !b && (b = !0), (b ? p : q).push({name: h.name, variadic: !0});
												break
											}
											j = !0
										}
							...
							}, definition: function()
							{
								...
								if(!("." !== o.currentChar() && "#" !== o.currentChar() || o.peek(/^[^{]*\}/)))
								{
									if(o.save(), b = o.$re(/^([#.](?:[\w-]|\\(?:[A-Fa-f0-9]{1,6} ?|[^A-Fa-f0-9]))+)\s*\(/))
									{
										...
										if(o.commentStore.length = 0, o.$str("when") && (d = k(n.conditions, "expected condition")), c = n.block())
										{
						...
						}, alpha: function()
						{
							...
							if(o.$re(/^opacity=/i))
							{
								return a = o.$re(/^\d+/), a || (a = k(this.entities.variable, "Could not parse alpha")), l(")"), new e.Alpha(a)
							}
						}, element: function()
						{
							var a, b, d, f = o.i;
							if(b = this.combinator(), a = o.$re(/^(?:\d+\.\d+|\d+)%/) || o.$re(/^(?:[.#]?|:*)(?:[\w-]|[^\x00-\x9f]|\\(?:[A-Fa-f0-9]{1,6} ?|[^A-Fa-f0-9]))+/) || o.$char("*") || o.$char("&") || this.attribute() || o.$re(/^\([^&()@]+\)/) || o.$re(/^[\.#:](?=@)/) || this.entities.variableCurly(), a || (o.save(), o.$char("(") ? (d = this.selector()) && o.$char(")") ? (a = new e.Paren(d), o.forget()) : o.restore("Missing closing ')'") : o.forget()), a)
							{
						...
						}, combinator: function()
						{
							...
							if("/" === a)
							{
								...
								if(b)
								{
									return o.forget(), new e.Combinator(b);
								}
								o.restore()
							}
							if(">" === a || "+" === a || "~" === a || "|" === a || "^" === a)
						...
						{
							for(var b, d, f, g, h, j, l,
									m = o.i; (a && (d = this.extend()) || a && (j = o.$str("when")) || (g = this.element())) && (j ? l = k(this.conditions, "expected condition") : l ? i("CSS guard can only be used at the end of selector") : d ? h = h ? h.concat(d) : d : (h && i("Extend can only be used at the end of selector"), f = o.currentChar(), b ? b.push(g) : b = [g], g = null), "{" !== f && "}" !== f && ";" !== f && "," !== f && ")" !== f);)
							{
								;
							}
						...
						}, detachedRuleset: function()
						{
							...
							if(a)
							{
								return new e.DetachedRuleset(a)
							}
						}, ruleset: function()
						{
							var b, c, d, f;
							for(o.save(), a.dumpLineNumbers && (f = m(o.i)); ;)
							{
								...
								if(b ? b.push(c) : b = [c], o.commentStore.length = 0, c.condition && b.length > 1 && i("Guards are only currently allowed on a single selector."), !o.$char(","))
								{
									break;
								}
						...
						{
							var d, f, g, h, i, j = o.i, k = o.currentChar();
							if("." !== k && "#" !== k && "&" !== k && ":" !== k)
							{
						...
						}, anonymousValue: function()
						{
							...
							if(a)
							{
								return new e.Anonymous(a[1])
							}
						}, "import": function()
						{
							var a, b, d = o.i, f = o.$re(/^@import?\s+/);
							if(f)
							{
								var g = (f ? this.importOptions() : null) || {};
								if(a = this.entities.quoted() || this.entities.url())
								{
									return b = this.mediaFeatures(), o.$char(";") || (o.i = d, i("missing semi-colon or unrecognised media features on import")), b = b && new e.Value(b), new e.Import(a, b, g, d, c);
								}
						...
						}, mediaFeature: function()
						{
							...
							o.save();
							do {
								a = d.keyword() || d.variable(), a ? f.push(a) : o.$char("(") && (b = this.property(), a = this.value(), o.$char(")") ? b && a ? f.push(new e.Paren(new e.Rule(b, a, null, null, o.i, c, (!0)))) : a ? f.push(new e.Paren(a)) : i("badly formed media feature definition") : i("Missing closing ')'", "Parse"));
							}
							while(a);
							if(o.forget(), f.length > 0)
							{
						...
						}, mediaFeatures: function()
						{
							...
							do {
								...
								else if(a = b.variable(), a && (c.push(a), !o.$char(",")))
								{
									break;
								}
							}
						...
						{
							var a, b = o.i, d = o.$re(/^@plugin?\s+/);
							if(d)
							{
								var f = {plugin: !0};
								if(a = this.entities.quoted() || this.entities.url())
								{
									return o.$char(";") || (o.i = b, i("missing semi-colon on plugin")), new e.Import(a, null, f, b, c);
								}
								o.i = b, i("malformed plugin statement")
							}
						}, directive: function()
						{
							var b, d, f, g, h, j, k, l = o.i, n = !0, p = !0;
							if("@" === o.currentChar())
							{
								if(d = this["import"]() || this.plugin() || this.media())
								{
									return d;
								}
						...
						}, value: function()
						{
							var a, b = [];
							do {
								if(a = this.expression(), a && (b.push(a), !o.$char(",")))
								{
									break;
								}
							}
						...
						{
							var a, b, c, d, f = this.entities, g = o.i;
							if(a = this.addition() || f.keyword() || f.quoted())
							{
								return o.$char(">") ? d = o.$char("=") ? ">=" : ">" : o.$char("<") ? d = o.$char("=") ? "<=" : "<" : o.$char("=") && (d = o.$char(">") ? "=>" : o.$char("<") ? "=<" : "="), d ? (b = this.addition() || f.keyword() || f.quoted(), b ? c = new e.Condition(d, a, b, g, (!1)) : i("expected expression")) : c = new e.Condition("=", a, new e.Keyword("true"), g, (!1)), c
							}
						}, operand: function()
						{
						...
						}, expression: function()
						{
							var a, b, c = [];
							do {
								a = this.comment(), a ? c.push(a) : (a = this.addition() || this.entity(), a && (c.push(a), o.peek(/^\/[\/*]/) || (b = o.$char("/"), b && c.push(new e.Anonymous(b)))));
							}
							while(a);
							if(c.length > 0)
							{
						...
						}, ruleProperty: function()
						{
							...
							if(h)
							{
								return f = [new e.Keyword(h[1])], o.forget(), f;
							}
							for(a(/^(\*?)/); ;)
							{
								if(!a(/^((?:[\w-]+)|(?:@\{[\w-]+\}))/))
							...
							if(f.length > 1 && a(/^((?:\+_|\+)?)\s*:/))
							{
								...
								{
									b = f[d], f[d] = "@" !== b.charAt(0) ? new e.Keyword(b) : new e.Variable("@" + b.slice(2, -1), g[d], c);
								}
								return f
							}
							o.restore()
		...
		40: [function(a, b, c)
		{
			var d = a("../less-error"), e = a("../tree"), f = b.exports = function(a, b)
			{
				this.fileInfo = b
			};
							...
							if(d)
							{
								for(i = 0; i < e.length; i++)
								{
									this._sourceMapGenerator.addMapping({
										...
										}, original: {line: f.length + i, column: 0 === i ? h.length : 0}, source: this.normalizeFilename(b.filename)
									});
								}
							}
							else
		...
		44: [function(a, b, c)
		{
			...
			b.exports = function(a, b)
			{
				...
				for(c = a.eval(h), i = 0; i < k.length; i++)
				{
					k[i].run(c);
				}
				return c
		...
		49: [function(a, b, c)
		{
			var d = a("./node"), e = a("../functions/function-caller"), f = function(a, b, c, d)
			{
		...
		50: [function(a, b, c)
		{
			...
			}, h.fromKeyword = function(a)
			{
				...
				if(g.hasOwnProperty(c) ? b = new h(g[c].slice(1)) : "transparent" === c && (b = new h([0, 0, 0], 0)), b)
				{
					return b.value = a, b
				}
			}, b.exports = h
		...
		55: [function(a, b, c)
		{
			var d = a("./node"), e = a("../contexts"), f = function(a, b)
			{
		...
		56: [function(a, b, c)
		{
			...
			}, h.prototype.operate = function(a, b, c)
			{
				...
				{
					"*" === b ? (e.numerator = e.numerator.concat(c.unit.numerator).sort(), e.denominator = e.denominator.concat(c.unit.denominator).sort(), e.cancel()) : "/" === b && (e.numerator = e.numerator.concat(c.unit.denominator).sort(), e.denominator = e.denominator.concat(c.unit.numerator).sort(), e.cancel());
				}
				return new h(d, e)
			}, h.prototype.compare = function(a)
			{
		...
		57: [function(a, b, c)
		{
			var d = a("./node"), e = a("./selector"), f = a("./ruleset"), g = function(a, b, c, d, f, g, h, i)
			{
				var j;
				if(this.name = a, this.value = b, c)
				{
					for(Array.isArray(c) ? this.rules = c : (this.rules = [c], this.rules[0].selectors = new e([], null, null, this.index, f).createEmptySelectors()), j = 0; j < this.rules.length; j++)
					{
		...
		61: [function(a, b, c)
		{
			var d = a("./node"), e = a("./media"), f = a("./url"), g = a("./quoted"), h = a("./ruleset"), i = a("./anonymous"), j = function(a, b, c, d, e, f)
			{
				if(this.options = c, this.index = d, this.path = a, this.features = b, this.currentFileInfo = e, this.allowRoot = !0, void 0 !== this.options.less || this.options.inline)
				{
			...
			}, j.prototype.doEval = function(a)
			{
				...
				{
					var f = new i(this.root, 0, {filename: this.importedFilename, reference: this.path.currentFileInfo && this.path.currentFileInfo.reference}, (!0), (!0));
		...
		66: [function(a, b, c)
		{
			var d = a("./ruleset"), e = a("./value"), f = a("./selector"), g = a("./anonymous"), h = a("./expression"), i = a("./directive"), j = function(a, b, c, g, h)
			{
		...
		67: [function(a, b, c)
		{
			...
			}, h.prototype.eval = function(a)
			{
				...
				throw n ? {type: "Runtime", message: "No matching definition was found for `" + this.format(t) + "`", index: this.index, filename: this.currentFileInfo.filename} : {
					type: "Name",
		...
		68: [function(a, b, c)
		{
			var d = a("./selector"), e = a("./element"), f = a("./ruleset"), g = a("./rule"), h = a("./expression"), i = a("../contexts"), j = function(a, b, c, f, g, h, i)
			{
			...
			{
				var e, j, k, l, m, n, o, p, q = new f(null, null), r = this.params.slice(0), s = 0;
						...
						if(j = c && c[p], n = r[k].name)
						{
							...
							else
							{
								...
								else
								{
									if(!r[k].value)
									{
										throw{type: "Runtime", message: "wrong number of arguments for " + this.name + " (" + s + " for " + this.arity + ")"};
									}
			...
			}, j.prototype.makeImportant = function()
			{
				...
				}) : this.rules, b = new j(this.name, this.params, a, this.condition, this.variadic, this.frames);
				return b
			}, j.prototype.eval = function(a)
			{
			...
			{
				var d, e, j = [], k = this.frames ? this.frames.concat(a.frames) : a.frames, l = this.evalParams(a, new i.Eval(a, k), b, j);
		...
		71: [function(a, b, c)
		{
			...
			}, g.prototype.eval = function(a)
			{
				...
				if(a.isMathOn())
				{
					if(b instanceof f && c instanceof e && (b = b.toColor()), c instanceof f && b instanceof e && (c = c.toColor()), !b.operate)
					{
						throw{
							type: "Operation",
		...
		73: [function(a, b, c)
		{
			var d = a("./node"), e = a("./js-eval-node"), f = a("./variable"), g = function(a, b, c, d, e)
			{
			...
			}, g.prototype.eval = function(a)
			{
				...
				var c = this, d = this.value, e = function(b, d)
				{
		...
		74: [function(a, b, c)
		{
			...
			var e = a("./node"), f = a("./value"), g = a("./keyword"), h = function(a, b, c, d, g, h, i, j)
			{
			...
			}, h.prototype.eval = function(a)
			{
				...
				try
				{
					if(a.importantScope.push({}), b = this.value.eval(a), !this.variable && "DetachedRuleset" === b.type)
					{
						throw{
		...
		76: [function(a, b, c)
		{
			var d = a("./node"), e = a("./rule"), f = a("./selector"), g = a("./element"), h = a("./paren"), i = a("../contexts"), j = a("../functions/function-registry"),
				k = a("../functions/default"), l = a("./debug-info"), m = function(a, b, c, d)
				{
			...
			{
				var b, c, d, f, g = this.selectors, h = !1;
				if(g && (c = g.length))
				{
					for(b = [], k.error({
						type: "Syntax",
				...
				var i, l, n = this.rules ? this.rules.slice(0) : null, o = new m(b, n, this.strictImports, this.visibilityInfo());
				...
				for(f = 0; f < r.length; f++)
				{
					if(i = r[f], i instanceof m && i.selectors && 1 === i.selectors.length && i.selectors[0].isJustParentSelector())
					{
						...
						{
							l = i.rules[u], l.copyVisibilityInfo(i.visibilityInfo()), l instanceof e && l.variable || r.splice(++f, 0, l)
						}
					}
				}
			...
			}, m.prototype.genCSS = function(a, b)
			{
				...
				var k, m = a.compress ? "" : Array(a.tabLevel + 1).join("  "), n = a.compress ? "" : Array(a.tabLevel).join("  "), o = 0, p = 0;
				...
				if(j = i.concat(j), !this.root)
				{
					...
					for(k = a.compress ? "," : ",\n" + n, d = 0; d < s; d++)
					{
						if(h = r[d], q = h.length)
						{
							for(d > 0 && b.add(k), a.firstSelector = !0, h[0].genCSS(a, b), a.firstSelector = !1, e = 1; e < q; e++)
							{
								h[e].genCSS(a, b);
							}
						}
			...
			}, m.prototype.joinSelector = function(a, b, c)
			{
				...
				function k(a, b)
				{
					...
					if(0 !== a.length)
					{
						if(0 === b.length)
						{
							return void b.push([new f(a)]);
						}
						for(c = 0; c < b.length; c++)
						{
							d = b[c], d.length > 0 ? d[d.length - 1] = d[d.length - 1].createDerived(d[d.length - 1].elements.concat(a)) : d.push(new f(a))
						}
					}
				}
				...
				function l(a, b, c)
				{
					...
					for(o = [], p = [[]], h = 0; h < c.elements.length; h++)
					{
						...
						else
						{
							for(v = !0, q = [], k(o, p), m = 0; m < p.length; m++)
							{
								if(r = p[m], 0 === b.length)
								{
									r.length > 0 && r[0].elements.push(new g(s.combinator, "", s.index, s.currentFileInfo)), q.push(r);
								}
								else
								{
					...
					{
						t = p[h].length, t > 0 && (a.push(p[h]), u = p[h][t - 1], p[h][t - 1] = u.createDerived(u.elements, c.extendList));
					}
					return v
				}
		...
		77: [function(a, b, c)
		{
			var d = a("./node"), e = a("./element"), f = function(a, b, c, d, e, f)
			{
		...
		79: [function(a, b, c)
		{
			var d = a("./node"), e = a("../data/unit-conversions"), f = function(a, b, c)
			{
		...
		82: [function(a, b, c)
		{
			...
			{
				var b, c = this.name;
				if(0 === c.indexOf("@@") && (c = "@" + new e(c.slice(1), this.index, this.currentFileInfo).eval(a).value), this.evaluating)
				{
					throw{
						type: "Name",
		...
		84: [function(a, b, c)
		{
			var d = a("../tree"), e = a("./visitor"), f = a("../logger"), g = function()
			{
			...
			g.prototype = {
				...
				}, visitRuleset: function(a, b)
				{
					if(!a.root)
					{
						var c, e, f, g, h = [], i = a.rules, j = i ? i.length : 0;
						for(c = 0; c < j; c++)
						{
						...
						{
							var l = k[c], m = l[l.length - 1], n = m.extendList;
							for(g = n ? n.slice(0).concat(h) : h, g && (g = g.map(function(a)
							{
								return a.clone()
							})), e = 0; e < g.length; e++)
							{
								this.foundExtends = !0, f = g[e], f.findSelfSelectors(l), f.ruleset = a, 0 === e && (f.firstExtendOnThisSelectorPath = !0), this.allExtendsStack[this.allExtendsStack.length - 1].push(f)
							}
						}
			...
			h.prototype = {
				...
				}, isElementValuesEqual: function(a, b)
				{
					...
					{
						return a.op === b.op && a.key === b.key && (a.value && b.value ? (a = a.value.value || a.value, b = b.value.value || b.value, a === b) : !a.value && !b.value);
					}
					if(a = a.value, b = b.value, a instanceof d.Selector)
					{
						...
						{
							if(a.elements[c].combinator.value !== b.elements[c].combinator.value && (0 !== c || (a.elements[c].combinator.value || " ") !== (b.elements[c].combinator.value || " ")))
							{
								return !1;
							}
		...
		86: [function(a, b, c)
		{
			var d = a("../contexts"), e = a("./visitor"), f = a("./import-sequencer"), g = function(a, b)
			{
			...
			g.prototype = {
				...
				}, visitImport: function(a, b)
				{
					...
					if(!a.css || c)
					{
						var e = new d.Eval(this.context, this.context.frames.slice(0)), f = e.frames[0];
		...
		90: [function(a, b, c)
		{
			...
			g.prototype = {
				...
				{
					if(!a.blocksVisibility() && !a.variable)
					{
						return a
					}
				}, visitMixinDefinition: function(a, b)
				...
				}, checkValidNodes: function(a, b)
				{
					if(a)
					{
						for(var c = 0; c < a.length; c++)
						{
							...
							{
								throw{message: "Function '" + e.name + "' is undefined", index: e.index, filename: e.currentFileInfo && e.currentFileInfo.filename};
							}
							if(e.type && !e.allowRoot)
							{
								throw{message: e.type + " node returned by a function is not valid here", index: e.index, filename: e.currentFileInfo && e.currentFileInfo.filename}
							}
						}
					}
				}, visitRuleset: function(a, b)
				...
				}, _compileRulesetPaths: function(a)
				{
					a.paths && (a.paths = a.paths.filter(function(a)
					{
						...
						{
							if(a[b].isVisible() && a[b].getIsOutput())
							{
								return !0;
							}
						}
				...
				}, _mergeRules: function(a)
				{
					if(a)
					{
						for(var b, c, e, f = {},
								g = 0; g < a.length; g++)
						{
							c = a[g], c instanceof d.Rule && c.merge && (e = [c.name, c.important ? "!" : ""].join(","), f[e] ? a.splice(g--, 1) : f[e] = [], f[e].push(c));
						}
		...
		91: [function(a, b, c)
		{
			...
			i.prototype = {
				visit: function(a)
				{
					...
					var c, e = this._visitFnCache, f = this._implementation, h = b << 1, i = 1 | h, j = e[h], k = e[i], l = g;
